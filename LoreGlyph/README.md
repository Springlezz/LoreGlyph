...
## Запуск
> [!NOTE]
> Также можете использовать докер файл или же docker run -p 8080:8080 -p 8081:8081 ваш_логин/loreglyph-backend:latest и docker run -p 8000:80 ваш_логин/loreglyph-frontend:latest
