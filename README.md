...
2. Добавление правописания слова с помощью графики (пользователь может рисовать символы)
3. Совместное редактирование слов по ссылке
4. Локализация на английском
5. Возможность комментировать язык в открытом доступе
