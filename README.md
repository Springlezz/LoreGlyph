...
## Запуск
> [!NOTE]
> Также можете использовать докер файл или же docker run -p 8080:8080 -p 8081:8081 springlezz/loreglyph-backend:latest и docker run -p 8000:80 springlezz/loreglyph-frontend:latest
...
2. Добавление аватарок, смена обложки языка
3. Функция делиться языком по ссылке
4. Добавление правописания слова с помощью графики
5. Совместное редактирование слов
6. Локализация на английском
