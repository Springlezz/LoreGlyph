...
1. Мобильную адаптацию (в процессе)
2. Добавление аватарок, смена обложки языка
3. Функция делиться языком по ссылке
4. Добавление правописания слова с помощью графики (пользователь может рисовать символы)
5. Совместное редактирование слов по ссылке
